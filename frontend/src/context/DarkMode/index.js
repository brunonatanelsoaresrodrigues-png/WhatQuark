      ...
      createMuiTheme(
        {
          palette: {
            ...
            primary: {
              light: "#36b7a5",
              main: darkMode ? "#6bd9c2" : "#08766c",
              dark: "#00574f",
              contrastText: "#ffffff"
            },
            secondary: {
              light: "#ff897f",
              main: darkMode ? "#ffb4ab" : "#b73f36",
              dark: "#bf4138",
              contrastText: "#ffffff"
            },
            background: {
            ...
            text: {
              ...
              secondary: darkMode ? "#a8c5c0" : "#526c67"
            },
          ...
          overrides: {
            ...
            MuiButton: {
              root: { borderRadius: 8, minHeight: 40, letterSpacing: 0 },
              containedPrimary: {
                color: "#ffffff",
