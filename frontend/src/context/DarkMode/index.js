    ...
    return createTheme(
      {
        ...
        typography: {
          ...
          h4: { fontWeight: 780, letterSpacing: "-0.025em" },
          h5: { fontWeight: 750, letterSpacing: "-0.018em" },
          h6: { fontWeight: 720, letterSpacing: "-0.012em" },
        ...
        overrides: {
          ...
          MuiCssBaseline: {
            "@global": {
              ...
              "::selection": { background: "rgba(54, 191, 174, .28)" },
              "*::-webkit-scrollbar": { width: 8, height: 8 },
              "*::-webkit-scrollbar-thumb": {
                borderRadius: 8,
                backgroundColor: mode.borderStrong
              ...
              ".Toastify__close-button": { color: mode.textMuted }
            }
          },
          MuiPaper: {
          ...
          MuiButton: {
            ...
            containedPrimary: {
              ...
              "&:hover": {
                background: `linear-gradient(135deg, ${colors.brandDark} 0%, ${colors.brandHover} 100%)`,
                boxShadow: "0 8px 20px rgba(12, 124, 114, .22)"
              },
              "&.Mui-disabled": {
            ...
            outlined: { borderColor: mode.borderStrong }
          },
          MuiIconButton: {
            root: {
          ...
          MuiDialog: {
            paper: { borderRadius: radii.lg, boxShadow: modeShadows.raised }
          },
          MuiTableHead: {
            root: { backgroundColor: mode.surfaceMuted }
          },
          MuiTableCell: {
            head: {
              color: mode.textMuted,
          ...
          MuiTableRow: {
            root: {
              ...
              "&:hover": { backgroundColor: mode.surfaceMuted }
            }
          },
          MuiTableContainer: { root: { borderRadius: 12 } },
          MuiChip: {
            root: {
          ...
          MuiOutlinedInput: {
            root: {
              borderRadius: radii.sm,
              "&.Mui-focused": { boxShadow: modeShadows.focus }
            },
            notchedOutline: { borderColor: mode.borderStrong }
          },
          MuiTab: {
            root: {
              minHeight: 48,
          ...
          MuiMenu: { paper: { border: `1px solid ${mode.border}` } },
          MuiTooltip: {
            tooltip: { borderRadius: radii.xs, fontSize: "0.76rem" }
          }
        }
      },
      ptBR
