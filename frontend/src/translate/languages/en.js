  ...
  en: {
    translations: {
      ...
      ticketsList: {
        ...
        noTicketsTitle: "No conversations here",
        noTicketsMessage: "No conversations match this status or search term.",
        ...
        header: {
          ...
          buttons: {
            ...
            waitingPatientCountdown:
              "Waiting for patient — {{remaining}} (cancel)",
      ...
      messageOptionsMenu: {
        ...
        editHelp: "{{count}} of {{limit}} characters · available for 15 minutes",
        editCancel: "Cancel",
        editSave: "Save",
